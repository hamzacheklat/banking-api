def update(self, status: str, filters: Dict[str, Any] = None, user_name: str = None) -> Dict[str, Any]:
    ...
    # On ajoute tous les filtres sauf ecosystem car il est géré à part
    ...
    if ecosystem == "all":
        ...
        updated_instances = self._handle_specific_ecosystem_update(
            line_all, line_specific, current_eco_list, input_eco_list, status, user_name, criterias_base
        )
